 ...
 *     <li> Registering callbacks. Calling {@link #onSuccess(com.ajjpj.afoundation.function.AStatement1NoThrow)}, {@link #onFailure(com.ajjpj.afoundation.function.AStatement1NoThrow)} or
 ...
 *           or {@link #mapAsync(com.ajjpj.afoundation.function.AFunction1, long, java.util.concurrent.TimeUnit) asynchronously}. You can also call one of the <code>zip</code> methods
...
public interface AFuture<T> {
     ...
     *  This method does for futures what {@link com.ajjpj.afoundation.collection.immutable.ACollection#map(com.ajjpj.afoundation.function.AFunction1)} does for collecctions.<p>
     *
     ...
     *  {@link com.ajjpj.afoundation.collection.immutable.ACollection#map(com.ajjpj.afoundation.function.AFunction1)} does for collecctions.<p>
     *
