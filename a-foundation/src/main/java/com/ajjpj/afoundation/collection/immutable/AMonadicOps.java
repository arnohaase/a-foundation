...
//TODO    <E extends Throwable> AMonadicOps<T, ? extends AFilterMonadic<T, ?>> withFilter(APredicate<T, E> pred) throws E;
     ...
     */
    <E extends Throwable> AOption<T> find(APredicate<? super T, E> pred) throws E;

    /**
     * Returns true iff all elements of the collection match the predicate.
     */
    <E extends Throwable> boolean forAll(APredicate<? super T, E> pred) throws E;

    /**
     * Returns true iff at least one element of the collection matches the predicate.
     */
    <E extends Throwable> boolean exists(APredicate<? super T, E> pred) throws E;
}
